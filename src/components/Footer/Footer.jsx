        ...
        <div  className="container-xxl">
          <div className="row">
            <div className="logo-div col-md-4">
              <img className="gb-logo" src="https://ik.imagekit.io/mtmwll7w3/images/logoGBfin.png?updatedAt=1698121417788" alt="logo" />
            </div>
        ...
        <div className="container-xxl">
          <div className="row" style={{paddingBottom: "0px"}}>
            <div className="col-12 mb-0 foot-content">
              <p className="text-center" style={{marginBottom: "0px"}}>&copy; {new Date().getFullYear()} Gamer's Burnout</p>
            </div>
          </div>
        </div>
